...
config. TitleBgColor	= '#E2E7FF'		// If empty string '', BorderColor will be used
config. TitleFontColor	= '#000044'		// Color of title text - if '', BgColor (of tooltip body) will be used
